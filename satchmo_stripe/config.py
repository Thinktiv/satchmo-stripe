...
config_register_list(
    ...
    StringValue(PAYMENT_GROUP,
                'PUB_API_KEY',
                description=_('The PUBLISHABLE API KEY for stripe payment processor'),
                help_text=_("Stripe Publishable API Key"),
                default=""),
    ...
    StringValue(PAYMENT_GROUP,
                'TEST_PUB_API_KEY',
                description=_("Stripe Publishable Test API Key"),
                help_text=_("Stripe Publishable Test API Key"),
                default=""),
